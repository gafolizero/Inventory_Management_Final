...
var signup = exports.signup = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee3(name, email, employeeID, employeeType, employeeDOB, role, department, joiningDate, password, passwordConfirm) {
    var res;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 3:
          res = _context3.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'User Sign Up successful');
          }
          _context3.next = 10;
          break;
        case 7:
...
var addSupplier = exports.addSupplier = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(supplierName, contactNumber, address, supplierID, email, representative, speciality) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Supplier added Successfully');
          }
          _context.next = 11;
          break;
        case 8:
  ...
  return function addSupplier(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addInventory.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var addInventory = exports.addInventory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(inventoryID, material, supplierID, thickness, quantity, length, width, finish, grain, inventoryType, itemType, referenceCode, leadTime, note) {
    var supplierObjID, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/suppliers/".concat(supplierID)
          });
        case 3:
          supplierObjID = _context.sent;
        ...
        case 9:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Inventory added Successfully');
          }
          _context.next = 17;
          break;
        case 13:
  ...
  return function addInventory(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9, _x10, _x11, _x12, _x13, _x14) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"addProject.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var addProject = exports.addProject = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, projectID, address, projectManager, siteManager, inventoryArr, client) {
    var inventorySendObj, _iterator, _step, el, invObjID, projectManagerID, siteManagerID, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          inventorySendObj = [];
          _iterator = _createForOfIteratorHelper(inventoryArr);
          _context.prev = 3;
          _iterator.s();
        case 5:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/inventory/inventoryID/".concat(el.inventoryItemId)
          });
        case 9:
          invObjID = _context.sent;
          inventorySendObj.push({
            inventoryItemId: "".concat(invObjID.data.data.document.id),
            inventoryquantity: "".concat(el.inventoryquantity)
          });
        case 11:
          _context.next = 5;
          break;
        ...
        case 21:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/projectManager/".concat(projectManager)
          });
        case 23:
          projectManagerID = _context.sent;
          _context.next = 26;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/siteManager/".concat(siteManager)
          });
        case 26:
          siteManagerID = _context.sent;
          _context.next = 29;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 29:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Project added Successfully');
          }
          _context.next = 36;
          break;
        case 33:
          ...
          if (_context.t1.response.data.message === 'No document found for the provided ID') (0, _alert.showAlert)('error', _context.t1.response.data.message);else (0, _alert.showAlert)('error', 'Cannot Create Project: Duplicate ID');
        case 36:
        case "end":
          return _context.stop();
      }
    }, _callee, null, [[0, 33], [3, 15, 18, 21]]);
  }));
  return function addProject(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"patchInventory.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.patchInventory = exports.inventoryUnload = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
var patchInventory = exports.patchInventory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(id, material, supplierID, thickness, quantity, length, width, finish, grain) {
    var res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/inventory/".concat(id),
            data: {
              material: material,
              supplierID: supplierID,
              thickness: thickness,
        ...
        case 3:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Inventory Updated Successfully');
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
  ...
  return function patchInventory(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
var inventoryUnload = exports.inventoryUnload = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "http://127.0.0.1:8000/api/v1/inventory/unload/".concat(id),
            data: {
              quantity: quantity
            }
          });
        case 3:
          res = _context2.sent;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Inventory Unloaded Successfully');
            window.setTimeout(function () {
  ...
  return function inventoryUnload(_x10, _x11) {
    return _ref2.apply(this, arguments);
  };
}();
...
exports.deleteInventory = void 0;
require("core-js/modules/es6.array.copy-within.js");
require("core-js/modules/es6.array.fill.js");
require("core-js/modules/es6.array.filter.js");
require("core-js/modules/es6.array.find.js");
...
var deleteInventory = exports.deleteInventory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          (0, _alert.showAlert)('success', 'Inventory Deleted.');
          window.setTimeout(function () {
            location.assign('/inventory/getAll');
          }, 1000);
          _context.next = 11;
  ...
  return function deleteInventory(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.filterInventory = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /*eslint-disable*/
var filterInventory = exports.filterInventory = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var materialFilter, supplierFilter, thicknessFilter, resSUPP, filter, material, supplier, thickness, filterString, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          materialFilter = document.getElementById('materialFilter').value.trim();
          supplierFilter = document.getElementById('supplierFilter').value.trim();
          thicknessFilter = document.getElementById('thicknessFilter').value.trim();
          if (!supplierFilter) {
            _context.next = 9;
            break;
          }
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/suppliers/".concat(supplierFilter)
          });
        case 7:
          resSUPP = _context.sent;
          supplierFilter = resSUPP.data.data.document.id;
        case 9:
          filter = {};
          material = materialFilter ? filter.material = "".concat(materialFilter) : '';
          supplier = supplierFilter ? filter.supplier = "".concat(supplierFilter) : '';
          thickness = thicknessFilter ? filter.thickness = "".concat(thicknessFilter) : '';
          filterString = '';
          Object.keys(filter).forEach(function (el) {
            filterString += "".concat(el, "=").concat(filter[el]) + '&';
          });
          filterString = filterString.slice(0, -1);
          _context.next = 18;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/inventory?".concat(filterString)
          });
        case 18:
          res = _context.sent;
          if (res.data.status === 'success') {
            window.setTimeout(function () {
              location.assign("/inventory/getAll?".concat(filterString));
            }, 1000);
          }
          _context.next = 25;
          break;
  ...
  return function filterInventory() {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"checkactivity.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkActivitySupp = exports.checkActivityInv = void 0;
var _axios = _interopRequireDefault(require("axios"));
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator.return && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, catch: function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var checkActivityInv = exports.checkActivityInv = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(invID, nextRowHistory) {
    var requiredInvObjIDResponse, requiredInvObjID, filteredHistoryResponse, resultOutput, existingRows;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/inventory/inventoryID/".concat(invID)
          });
        case 3:
          requiredInvObjIDResponse = _context.sent;
          requiredInvObjID = requiredInvObjIDResponse.data.data.document.id;
          _context.next = 7;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/history?modifiedID=".concat(requiredInvObjID)
          });
        case 7:
          filteredHistoryResponse = _context.sent;
          resultOutput = filteredHistoryResponse.data.data.document;
          existingRows = nextRowHistory.querySelectorAll('.history-inv-body .history-data-row');
        ...
        case 12:
          resultOutput.forEach(function (el) {
            var formattedDate = new Date(el.date).toISOString().split('T')[0];
            var historyInvBody = nextRowHistory.querySelector('.history-inv-body');
            var HTMLROW = " \n      <tr class=\"history-data-row\">\n        <td class=\"date\">".concat(formattedDate, "</td>\n        <td class=\"modified\">").concat(el.modified, "</td>\n        <td class=\"action\">").concat(el.action, "</td>\n        <td class=\"modifiedName\">").concat(el.modifiedName, "</td>\n        <td class=\"modifiedID\">").concat(el.itemID, "</td>\n        <td class=\"unloadCountTable\">").concat(el.unloadCount, "</td>\n        <td class=\"historyUser\">").concat(el.user, ", ").concat(el.userID, "</td>\n    </tr>\n      ");
        ...
        case 15:
          _context.prev = 15;
          _context.t0 = _context["catch"](0);
          console.error(_context.t0.response ? _context.t0.response.data.message : _context.t0.message);
        case 18:
        case "end":
          return _context.stop();
      }
  ...
  return function checkActivityInv(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
var checkActivitySupp = exports.checkActivitySupp = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(suppID, nextRowHistory) {
    var requiredSuppObjIDResponse, requiredSuppObjID, filteredHistoryResponse, resultOutput, existingRows;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/suppliers/".concat(suppID)
          });
        case 4:
          requiredSuppObjIDResponse = _context2.sent;
          requiredSuppObjID = requiredSuppObjIDResponse.data.data.document.id;
          _context2.next = 8;
          return (0, _axios.default)({
            method: 'GET',
            url: "http://127.0.0.1:8000/api/v1/history?modifiedID=".concat(requiredSuppObjID)
          });
        case 8:
          filteredHistoryResponse = _context2.sent;
          resultOutput = filteredHistoryResponse.data.data.document;
          existingRows = nextRowHistory.querySelectorAll('.history-inv-body .history-data-row');
          if (!(existingRows.length > 0)) {
            _context2.next = 13;
        ...
        case 16:
          _context2.prev = 16;
          _context2.t0 = _context2["catch"](0);
          console.error(_context2.t0.response ? _context2.t0.response.data.message : _context2.t0.message);
        case 19:
        case "end":
          return _context2.stop();
      }
  ...
  return function checkActivitySupp(_x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js"}],"getAll.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.getAllSupplier = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var getAllSupplier = exports.getAllSupplier = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var allSuppliers;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", allSuppliers);
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alert.showAlert)('error', _context.t0.response.data.message);
  ...
  return function getAllSupplier() {
    return _ref.apply(this, arguments);
  };
}();
...
var _addSupplier = require("./addSupplier");
var _addInventory = require("./addInventory");
var _addProject = require("./addProject");
var _patchInventory = require("./patchInventory");
var _delete = require("./delete");
var _filter = require("./filter");
var _alert = require("./alert");
var _updateSettings = require("./updateSettings");
var _checkactivity = require("./checkactivity");
...
var supplierForm = document.querySelector('.form-supplier');
var inventoryForm = document.querySelector('.form-inventory');
var projectForm = document.querySelector('.form-project');
var patchInventoryForm = document.querySelector('.form-inventory-patch');
var logOutBtn = document.querySelector('.nav__el--logout');
var formDeleteInventory = document.querySelector('.form-delete-inventory');
var newSingUpForm = document.querySelector('.form-user-signup');
var allInvFilter = document.querySelector('.all-inventory-filter');
var unloadEventClick = document.querySelector('.unload-event-click');
var unloadFormCloseBtn = document.querySelector('.close-unload-button');
var unloadForm = document.querySelector('.unload-material-form');
var userDataForm = document.querySelector('.form-user-data-updateMe');
var userPasswordForm = document.querySelector('.form-user-data-password');
var historySection = document.querySelector('.history-section');
var historyBtn = document.querySelector('.btn-history');
var checkactivityForInv = document.querySelector('.table-for-history-inv');
var checkactivityForSupp = document.querySelector('.table-for-history-supp');
var toggleHistory = 0;
if (historyBtn) {
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('nameUpdateMe').value.trim();
    var email = document.getElementById('emailUpdateMe').value.trim();
...
if (unloadForm) {
  unloadForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var materialAvailableId = document.querySelector('.material-unload-id').textContent.trim();
    var materialUnload = document.getElementById('materialUnload').value;
    var materialAvailableQuantity = document.querySelector('.material-unload-available').textContent;
    if (Number(materialUnload) < 0) {
      (0, _alert.showAlert)('error', 'Not Valid.');
      return;
    }
    if (Number(materialAvailableQuantity) < Number(materialUnload)) {
      (0, _alert.showAlert)('error', 'Not Enough Inventory for Unload.');
    }
    if (Number(materialAvailableQuantity) >= Number(materialUnload)) {
      var remainingQuantity = Number(materialAvailableQuantity) - Number(materialUnload);
      (0, _patchInventory.inventoryUnload)(materialAvailableId, remainingQuantity);
    }
  });
}
if (unloadFormCloseBtn) {
  unloadFormCloseBtn.addEventListener('click', function (e) {
    e.preventDefault();
    var unloadForm = document.querySelector('.unload-material-form');
...
if (unloadEventClick) {
  unloadEventClick.addEventListener('click', function (e) {
    e.preventDefault();
    if (e.target.classList.contains('btn-unload')) {
      var _unloadForm = document.querySelector('.unload-material-form');
      _unloadForm.classList.remove('hide__content');
      var selectedRow = e.target.closest('tr');
      var materialAvailableName = document.querySelector('.material-unload-name');
      var materialAvailableId = document.querySelector('.material-unload-id');
      var materialAvailableSupplier = document.querySelector('.material-unload-supplier');
      var materialAvailableQuantity = document.querySelector('.material-unload-available');
      materialAvailableName.textContent = selectedRow.querySelector('.inventory-material').textContent;
      materialAvailableId.textContent = selectedRow.querySelector('.inventory-id').textContent;
      materialAvailableSupplier.textContent = selectedRow.querySelector('.inventory-supplier').textContent;
      materialAvailableQuantity.textContent = selectedRow.querySelector('.inventory-quantity').textContent;
    }
  });
}
if (allInvFilter) {
...
var formatDate = function formatDate(valInput) {
  var _valInput$split = valInput.split('-'),
    _valInput$split2 = _slicedToArray(_valInput$split, 3),
    year = _valInput$split2[0],
    month = _valInput$split2[1],
    day = _valInput$split2[2];
  var formattedDate = "".concat(year, "/").concat(month, "/").concat(day);
  return formattedDate;
};
if (newSingUpForm) {
  newSingUpForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var name = document.getElementById('newName').value;
    var email = document.getElementById('newEmail').value;
    var newemployeeID = document.getElementById('newemployeeID').value;
    var newemployeeType = document.getElementById('newemployeeType').value;
    var employeeDOB = document.getElementById('newemployeeDOB').value;
    var role = document.getElementById('newRole').value;
    var department = document.getElementById('newdepartment').value;
    var joiningDate = document.getElementById('newjoiningDate').value;
    ...
    (0, _login.signup)(name, email, newemployeeID, newemployeeType, employeeDOB, role, department, joiningDate, password, passwordConfirm);
  });
}
if (formDeleteInventory) {
  formDeleteInventory.addEventListener('submit', function (e) {
    e.preventDefault();
    var invId = document.querySelector('.forID').textContent.trim();
    var invIdForm = document.getElementById('inventoryDeleteId').value.trim();
    if (invId === invIdForm) {
      (0, _delete.deleteInventory)(invId);
    } else if (invId !== invIdForm) {
      (0, _alert.showAlert)('error', 'Please Confirm ID');
    }
  });
}
if (supplierForm) {
  supplierForm.addEventListener('submit', function (e) {
    ...
    (0, _addSupplier.addSupplier)(supplierName, contactNumber, address, supplierID, email, representative, speciality);
    supplier = '';
    '', _readOnlyError("contactNumber");
...
if (inventoryForm) {
  inventoryForm.addEventListener('submit', function (e) {
    ...
    var itemType = document.querySelector('.itemType-input').value;
    var referenceCode = document.getElementById('referenceCode').value;
    var leadTime = document.getElementById('leadTime').value;
    var note = document.getElementById('note').value;
    (0, _addInventory.addInventory)(inventoryID, material, supplierid, thickness, quantity, length, width, finish, grain, inventoryType, itemType, referenceCode, leadTime, note);
  });
  var inventoryTypeSelect = document.querySelector('#inventoryType');
  var itemTypeLabel = document.querySelector('.itemType-label');
  function updateItemTypeLabel() {
    var selectedValue = inventoryTypeSelect.value;
  ...
  updateItemTypeLabel();
  var allSuppliers = [];
  (0, _getAll.getAllSupplier)().then(function (e) {
    allSuppliers = e.data.data.document;
  });
  var inputField = document.querySelector('#supplierID');
  var suggestionsContainer = document.querySelector('#supplierSuggestions');

  // Function to filter suppliers based on the query (case-insensitive search)
  function filterSuppliers(query) {
    var filtered = allSuppliers.filter(function (supplier) {
      return supplier.supplierID.toLowerCase().includes(query.toLowerCase()) || supplier.supplierName.toLowerCase().includes(query.toLowerCase());
    });
    return filtered;
  }
  ...
  function renderSuggestions(filteredSuppliers) {
    ...
    filteredSuppliers.forEach(function (supplier) {
      ...
      optionElement.textContent = "".concat(supplier.supplierName, " (").concat(supplier.supplierID, ")");
  ...
  inputField.addEventListener('input', function () {
    ...
    if (query) {
      var filteredSuppliers = filterSuppliers(query);
...
if (patchInventoryForm) {
  patchInventoryForm.addEventListener('submit', function (e) {
    e.preventDefault();
    var forID = document.querySelector('.forID').textContent;
    var materialPatch = document.getElementById('materialPatch').value;
    var supplieridPatch = document.getElementById('supplieridPatch').value;
    var thicknessPatch = document.getElementById('thicknessPatch').value;
    var quantityPatch = document.getElementById('quantityPatch').value;
    var lengthPatch = document.getElementById('lengthPatch').value;
    var widthPatch = document.getElementById('widthPatch').value;
    var finishPatch = document.getElementById('finishPatch').value;
    var grainPatch = document.getElementById('grainPatch').value;
    (0, _patchInventory.patchInventory)(forID, materialPatch, supplieridPatch, thicknessPatch, quantityPatch, lengthPatch, widthPatch, finishPatch, grainPatch);
  });
}
var openSideBarALL = document.querySelectorAll('.open-sidebar');
var sidebar = document.querySelector('.sidebar');
var premiumTags = document.querySelectorAll('.premium-tag');
var body = document.querySelector('body');
var headerNav = document.querySelector('.header-nav');
premiumTags.forEach(function (tag) {
  tag.style.display = 'none';
});
openSideBarALL.forEach(function (sidebarButton) {
  return sidebarButton.onclick = function (event) {
    ...
    document.querySelectorAll('.dropdown.active--1').forEach(function (dropdown) {
...
var toggleDropdown = function toggleDropdown(event) {
  ...
  var parentLi = event.currentTarget.parentElement;
  parentLi.classList.toggle('active--1');
  dropdown.style.display = parentLi.classList.contains('active--1') && sidebar.classList.contains('active--1') ? 'block' : 'none';
};
document.querySelectorAll('.dropdown-toggle').forEach(function (el) {
  return el.addEventListener('click', toggleDropdown);
});
...
document.addEventListener('click', function (event) {
  ...
  if (!sidebar.contains(event.target) && !event.target.closest('.open-sidebar')) {
      ...
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            ...
            inventoryIdAll = document.querySelectorAll('.inventoryId');
            inventoryQuantityAll = document.querySelectorAll('.inventoryQuantity');
            invArray = [];
            for (i = 0; i < inventoryIdAll.length; i++) {
              invArray.push({
            ...
            _context2.next = 17;
            return (0, _addProject.addProject)(projectName, projectId, address, projectManagerId, siteManagerId, invArray, client);
          case 17:
...
if (checkactivityForInv) {
  var tableSelect = document.querySelector('.inventory-table');
  tableSelect.addEventListener('click', function (e) {
    if (e.target.classList.contains('btn-checkHistory')) {
      e.preventDefault();
      if (e.target.classList.contains('btn-checkHistory')) {
        var nextRowHistory = e.target.closest('tr').nextElementSibling;
        e.target.closest('tr').nextElementSibling.classList.toggle('hide__content');
        var id = e.target.closest('tr').querySelector('.inventory-id').textContent;
        (0, _checkactivity.checkActivityInv)(id, nextRowHistory);
      }
    }
  });
}
if (checkactivityForSupp) {
  var _tableSelect = document.querySelector('.supplier-table');
  _tableSelect.addEventListener('click', function (e) {
    if (e.target.classList.contains('btn-checkHistory')) {
      e.preventDefault();
      if (e.target.classList.contains('btn-checkHistory')) {
        var nextRowHistory = e.target.closest('tr').nextElementSibling;
        e.target.closest('tr').nextElementSibling.classList.toggle('hide__content');
        var id = e.target.closest('tr').querySelector('.supplier-id').textContent;
        (0, _checkactivity.checkActivitySupp)(id, nextRowHistory);
      }
    }
  });
}
},{"./login":"login.js","./addSupplier":"addSupplier.js","./addInventory":"addInventory.js","./addProject":"addProject.js","./patchInventory":"patchInventory.js","./delete":"delete.js","./filter":"filter.js","./alert":"alert.js","./updateSettings":"updateSettings.js","./checkactivity":"checkactivity.js","./getAll":"getAll.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
